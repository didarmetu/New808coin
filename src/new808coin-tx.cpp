...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("New808coin Core new808coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  new808coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded new808coin transaction") + "\n" +
                               "  new808coin-tx [options] -create [commands]   " + _("Create hex-encoded new808coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded new808coin transaction
