...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    /* NPhsfzkfqeMvt2FdFW8op3AeNhD3FyDgrm is not owned by the test wallet. */
    BOOST_CHECK_THROW(CallRPC("setaccount NPhsfzkfqeMvt2FdFW8op3AeNhD3FyDgrm nullaccount"), runtime_error);
    ...
    BOOST_CHECK_THROW(CallRPC("signmessage NPhsfzkfqeMvt2FdFW8op3AeNhD3FyDgrm mymessage"), runtime_error);
    ...
    /* wrong address */
    BOOST_CHECK(CallRPC("verifymessage NPhsfzkfqeMvt2FdFW8op3AeNhD3FyDgrm " + retValue.get_str() + " mymessage").get_bool() == false);
