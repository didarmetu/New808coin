...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("New808coin Core"),
     ...
     * override -datadir in the new808coin.conf file in the default data directory
     * (to be consistent with new808coind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
