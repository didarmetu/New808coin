...
int nStakeTargetSpacing = 808; // New808coin: 808 seconds blocks during POS (block 809+)
...
{
    // New808coin will hash in the transaction hash and the index number in order to make sure each hash is unique
