...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"new808coin", "startmasternode", &startmasternode, true, true, true},
        {"new808coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"new808coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, true},
        ...
        {"new808coin", "preparebudget", &preparebudget, true, true, true},
