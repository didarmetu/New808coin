...
static RPCWorkGuard* rpc_dummy_work = NULL;
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop New808coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "New808coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* New808coin features */
        {"new808coin", "masternode", &masternode, true, true, false},
        {"new808coin", "listmasternodes", &listmasternodes, true, true, false},
        {"new808coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"new808coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"new808coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"new808coin", "masternodedebug", &masternodedebug, true, true, false},
        {"new808coin", "startmasternode", &startmasternode, true, true, false},
        {"new808coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"new808coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"new808coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"new808coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"new808coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"new808coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"new808coin", "mnbudget", &mnbudget, true, true, false},
        {"new808coin", "preparebudget", &preparebudget, true, true, false},
        {"new808coin", "submitbudget", &submitbudget, true, true, false},
        {"new808coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"new808coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"new808coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"new808coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"new808coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"new808coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"new808coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"new808coin", "checkbudgets", &checkbudgets, true, true, false},
        {"new808coin", "mnsync", &mnsync, true, true, false},
        {"new808coin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StopRPCThreads()
{
    ...
    rpc_acceptors.clear();
    BOOST_FOREACH (const PAIRTYPE(std::string, boost::shared_ptr<RPCTimer>) & timer, deadlineTimers) {
        try {
            timer.second->cancel();
        } catch (const boost::system::system_error& e) {
            LogPrintf("%s: Warning: %s when cancelling timer", __func__, e.what());
        }
    }
...
{
    return "> new808coin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8089/\n";
}
