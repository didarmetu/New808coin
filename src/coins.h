...
/**
    ...
    ****Note - for New808coin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of new808coin coming in to a transaction
