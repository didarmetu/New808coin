...
In order to support loading of multiple wallets in new808coin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is new808coin.cpp.
...
Changes to new808coin.cpp
----------------------
new808coin.cpp is the entry point into new808coin-qt, and as such, will require some minor modifications to provide hooks for
