...
*Setup instructions for a gitian build of New808coin using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the New808coin
...
- [Building New808coin](#building-new808coin)
...
Clone the git repositories for new808coin and gitian and then checkout the new808coin version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/new808coin/new808coin.git
cd new808coin
...
Follow the instructions in [doc/release-process.md](release-process.md) in the new808coin repository
...
To build New808coin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the new808coin repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/new808coin/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/new808coin/new808coin
...
For example:
```bash
URL=https://github.com/konez2k/new808coin.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit new808coin=${COMMIT} --url new808coin=${URL} ../new808coin/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit new808coin=${COMMIT} --url new808coin=${URL} ../new808coin/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit new808coin=${COMMIT} --url new808coin=${URL} ../new808coin/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/new808coin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/new808coin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/new808coin-build.assert
```
...
[new808coin/gitian.sigs](https://github.com/didarmetu/gitian.sigs/) repository, or if that's not possible to create a pull
request.
