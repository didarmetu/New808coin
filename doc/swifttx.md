...
This mechanism has been integrated into Bitcore-Node-New808coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/new808coin/insight-api-new808coin#web-socket-api](https://github.com/didarmetu/insight-api-new808coin#web-socket-api)
* API: [https://github.com/new808coin/insight-api-new808coin#swifttx-transactions](https://github.com/didarmetu/insight-api-new808coin#swifttx-transactions)
...
By default, the New808coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the New808coin Core daemon:
