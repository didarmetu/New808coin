Contributing to New808coin Core
==================================

The New808coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the New808coin Core project, and is not to be
confused with overall New808coin Network Protocol consensus changes.

Whether a pull request is merged into New808coin Core rests with the project merge
...
Patches that change New808coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the New808coin consensus, it must have been
...
The project leader is the release manager for each New808coin Core release.
