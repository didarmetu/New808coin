...
#   c) node1 mines 32 blocks, so now node 0 has 500000N808, node 1 has 4250N808, node2 has none.
#   d) node0 sends 601 N808 to node2, in two transactions (301 N808, then 300 N808).
